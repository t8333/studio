...
>(({ className, onClick, children, asChild: triggerAsChildProp, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      asChild={triggerAsChildProp}
      {...props}
    >
      {triggerAsChildProp ? children : (children || (<><PanelLeft /><span className="sr-only">Toggle Sidebar</span></>))}
    </Button>
  );
});
